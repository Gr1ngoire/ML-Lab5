...
network.save_weights('fmnist_weights.h5')
...
tst = 255 - cv2.imread('tshirt_to_guess.png', 0)
...
tst = 255 - cv2.imread('trousers_to_guess.jpg', 0)
tst = cv2.resize(tst, (28, 28))
tst = tst.reshape((1, 28 * 28))
tst = tst.astype('float32') / 255
...
tst = 255 - cv2.imread('shoes_to_guess.jpg', 0)
tst = cv2.resize(tst, (28, 28))
tst = tst.reshape((1, 28 * 28))
tst = tst.astype('float32') / 255
